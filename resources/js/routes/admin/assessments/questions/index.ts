...
/**
* @see \App\Modules\Assessment\Http\Controllers\AssessmentQuestionController::bulk
 ...
 */
export const bulk = (args: { assessment: number | { id: number } } | [assessment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/assessments/{assessment}/questions/bulk'
 */
bulk.url = (args: { assessment: number | { id: number } } | [assessment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { assessment: args }
    }
 ...
 * @route '/admin/assessments/{assessment}/questions/bulk'
 */
bulk.post = (args: { assessment: number | { id: number } } | [assessment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: bulk.url(args, options),
    method: 'post',
})
 ...
 * @route '/admin/assessments/{assessment}/questions/bulk'
 */
    const bulkForm = (args: { assessment: number | { id: number } } | [assessment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/assessments/{assessment}/questions/bulk'
 */
        bulkForm.post = (args: { assessment: number | { id: number } } | [assessment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: bulk.url(args, options),
            method: 'post',
        })
    ...
    bulk.form = bulkForm
/**
* @see \App\Modules\Assessment\Http\Controllers\AssessmentQuestionController::template
