...
export default function Edit({
  ...
  const initialCourses: SelectedCourse[] = (path.courses || [])
  ...
  const [selectedCourses, setSelectedCourses] = useState<SelectedCourse[]>(initialCourses);
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    post(`/admin/learning-paths/${path.id}`, { forceFormData: true });
  };
              ...
              <div className="form-control w-full">
                <label className="label">
                  ...
                  <span className="label-text-alt text-base-content/60">
                    {path.cover_image ? 'Cambiar imagen' : 'Opcional'}
                  </span>
                </label>
                <input
                  type="file"
                ...
                />
                {path.cover_image && !data.cover_image && (
                  <label className="label">
                    <span className="label-text-alt text-base-content/60">
                      Imagen actual: {path.cover_image.split('/').pop()}
                    </span>
                  </label>
                )}
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-base-content/60">
                  Ajusta el orden y la obligatoriedad de cada curso.
                </p>
              </div>
