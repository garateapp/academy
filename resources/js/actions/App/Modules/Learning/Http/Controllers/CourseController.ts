 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:129
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:144
 * @route '/courses'
 */
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:179
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:343
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:366
 * @route '/courses/{course}'
 */
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:411
 * @route '/courses/{course}'
 */
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:490
...
export const enrollUsers = (args: { course: number | { id: number } } | [course: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: enrollUsers.url(args, options),
    method: 'post',
})

enrollUsers.definition = {
    methods: ["post"],
...
enrollUsers.url = (args: { course: number | { id: number } } | [course: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return enrollUsers.definition.url
            .replace('{course}', parsedArgs.course.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 */
    const enrollUsersForm = (args: { course: number | { id: number } } | [course: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: enrollUsers.url(args, options),
        method: 'post',
    })
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:552
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:430
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:451
 ...
 * @see app/Modules/Learning/Http/Controllers/CourseController.php:472
...
const CourseController = { index, create, store, show, edit, update, destroy, enrollUsers, selfEnroll, publish, unpublish, archive }
