...
/**
* @see \App\Modules\Identity\Http\Controllers\RoleController::index
 * @see app/Modules/Identity/Http/Controllers/RoleController.php:22
 * @route '/admin/roles'
 */
...
/**
* @see \App\Modules\Identity\Http\Controllers\RoleController::create
 * @see app/Modules/Identity/Http/Controllers/RoleController.php:36
...
/**
* @see \App\Modules\Identity\Http\Controllers\RoleController::store
 * @see app/Modules/Identity/Http/Controllers/RoleController.php:51
 * @route '/admin/roles'
 */
...
/**
* @see \App\Modules\Identity\Http\Controllers\RoleController::show
 * @see app/Modules/Identity/Http/Controllers/RoleController.php:80
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Modules\Identity\Http\Controllers\RoleController::edit
 * @see app/Modules/Identity/Http/Controllers/RoleController.php:94
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Modules\Identity\Http\Controllers\RoleController::update
 * @see app/Modules/Identity/Http/Controllers/RoleController.php:113
 * @route '/admin/roles/{role}'
 */
...
/**
* @see \App\Modules\Identity\Http\Controllers\RoleController::destroy
 * @see app/Modules/Identity/Http/Controllers/RoleController.php:151
 * @route '/admin/roles/{role}'
 */
...
/**
* @see \App\Modules\Identity\Http\Controllers\RoleController::duplicate
 * @see app/Modules/Identity/Http/Controllers/RoleController.php:188
 * @route '/admin/roles/{role}/duplicate'
 */
export const duplicate = (args: { role: number | { id: number } } | [role: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
duplicate.definition = {
    methods: ["post"],
    url: '/admin/roles/{role}/duplicate',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/admin/roles/{role}/duplicate'
 */
duplicate.url = (args: { role: number | { id: number } } | [role: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { role: args }
    }
 ...
 * @route '/admin/roles/{role}/duplicate'
 */
duplicate.post = (args: { role: number | { id: number } } | [role: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: duplicate.url(args, options),
    method: 'post',
})
 ...
 * @route '/admin/roles/{role}/duplicate'
 */
    const duplicateForm = (args: { role: number | { id: number } } | [role: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/roles/{role}/duplicate'
 */
        duplicateForm.post = (args: { role: number | { id: number } } | [role: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: duplicate.url(args, options),
            method: 'post',
        })
    
    duplicate.form = duplicateForm
const RoleController = { index, create, store, show, edit, update, destroy, duplicate }
